...
<div className="flex justify-center">
  <div className="relative group">
    <img
      src={`${import.meta.env.BASE_URL}img/me.png`}      alt="Samiksha"
...
<div className="font-allerta">
  ...
  <div className="skills-canvas">
    <img src={`${import.meta.env.BASE_URL}img/skills/blender.png`} className="skill s1"/>
<img src={`${import.meta.env.BASE_URL}img/skills/unity.png`} className="skill s2"/>
<img src={`${import.meta.env.BASE_URL}img/skills/vscode.png`} className="skill s3"/>
<img src={`${import.meta.env.BASE_URL}img/skills/figma.png`} className="skill s4"/>
<img src={`${import.meta.env.BASE_URL}img/skills/react.png`} className="skill s5"/>
<img src={`${import.meta.env.BASE_URL}img/skills/java.png`} className="skill s6"/>
<img src={`${import.meta.env.BASE_URL}img/skills/mysql.png`} className="skill s7"/>
<img src={`${import.meta.env.BASE_URL}img/skills/csharp.png`} className="skill s8"/>
<img src={`${import.meta.env.BASE_URL}img/skills/canva.png`} className="skill s9"/>
<img src={`${import.meta.env.BASE_URL}img/skills/androidStudio.png`} className="skill s10"/>
<img src={`${import.meta.env.BASE_URL}img/skills/django.jpg`} className="skill s11"/>
<img src={`${import.meta.env.BASE_URL}img/skills/htmlcss.png`} className="skill s12"/>
<img src={`${import.meta.env.BASE_URL}img/skills/selenium.png`} className="skill s13"/>
